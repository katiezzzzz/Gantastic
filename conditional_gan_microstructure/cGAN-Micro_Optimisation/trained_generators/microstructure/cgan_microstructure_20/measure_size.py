...
img = cv2.imread(PATH+f"/cgan_microstructure_20[{current_fig}].tif", cv2.IMREAD_UNCHANGED)
...
coords = peak_local_max(distances, exclude_border=(15,15), footprint=np.ones((8,8)), labels=img)
