...
imgs2, noise, netG = transit_video(forest_lbl, sea_lbl, n_classes, noise, netG, lf=lf, ratio=ratio, device=device, step_size=1, z_step_size=0.1, l_step_size=0.1, transit_mode='scroll')
