...
print(imgs1.shape)
imgs2, noise, netG = transit_video(forest_lbl, desert_lbl, n_classes, noise, netG, lf, ratio, device, step_size=0.2, z_step_size=0.25, l_step_size=0.25, transit_mode='uniform')
print(imgs2.shape)
imgs3, noise, netG = roll_video(proj_path, desert_lbl, netG, n_classes, z_dim, lf, device, ratio, n_clips=int(35/(1/0.2)), step_size=0.2, original_noise=noise)
print(imgs3.shape)
imgs4, noise, netG = effects(desert_lbl, sea_lbl, n_classes, noise, netG, lf, ratio, device, step_size=0.2, z_step_num=2, l_step_size=1, z_max_num=4, effect='circles', n_circles=5)
print(imgs4.shape)
imgs5, noise, netG = roll_video(proj_path, desert_lbl, netG, n_classes, z_dim, lf, device, ratio, n_clips=int(10/(1/0.2)), step_size=0.2, original_noise=noise)
print(imgs5.shape)
imgs6, noise, netG = effects(desert_lbl, sea_lbl, n_classes, noise, netG, lf, ratio, device, step_size=0.2, z_step_num=2, l_step_size=1, z_max_num=4, effect='circles', n_circles=5)
print(imgs6.shape)
imgs7, noise, netG = roll_video(proj_path, desert_lbl, netG, n_classes, z_dim, lf, device, ratio, n_clips=int(15/(1/0.2)), step_size=0.2, original_noise=noise)
print(imgs7.shape)
imgs8, noise, netG = effects(desert_lbl, sea_lbl, n_classes, noise, netG, lf, ratio, device, step_size=0.2, z_step_num=2, l_step_size=1, z_max_num=4, effect='circles', n_circles=5)
print(imgs8.shape)
imgs9, noise, netG = roll_video(proj_path, desert_lbl, netG, n_classes, z_dim, lf, device, ratio, n_clips=int(50/(1/0.2)), step_size=0.2, original_noise=noise)
print(imgs9.shape)
imgs10, noise, netG = transit_video(desert_lbl, sea_lbl, n_classes, noise, netG, lf, ratio, device, step_size=0.2, z_step_size=0.33, l_step_size=1, transit_mode='circular')
print(imgs10.shape)
imgs11, noise, netG = roll_video(proj_path, sea_lbl, netG, n_classes, z_dim, lf, device, ratio, n_clips=int(45/(1/0.2)), step_size=0.2, original_noise=noise)
#imgs4, noise, netG = change_noise(star_lbl, noise, netG, n_classes, z_dim, lf=lf, device=device, ratio=ratio, n_clips=15, step_size=0.25, value=0.003, method='add')
print(imgs11.shape)
imgs12, noise, netG = roll_video(proj_path, sea_lbl, netG, n_classes, z_dim, lf, device, ratio, n_clips=int(76/(1/0.25)), step_size=0.25, original_noise=noise)
print(imgs12.shape)
imgs13, noise, netG = roll_video(proj_path, sea_lbl, netG, n_classes, z_dim, lf, device, ratio, n_clips=int(116/(1/0.5)), step_size=0.5, original_noise=noise)
print(imgs13.shape)
imgs14, noise, netG = roll_video(proj_path, sea_lbl, netG, n_classes, z_dim, lf, device, ratio, n_clips=30, step_size=1, original_noise=noise)
print(imgs14.shape)
